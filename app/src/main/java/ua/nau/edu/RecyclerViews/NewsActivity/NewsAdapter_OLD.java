...
public class NewsAdapter_OLD extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NewsAdapter_OLD(ArrayList<NewsDataModel> data, Context context, RecyclerView recyclerView) {
        this.dataSet = data;
    ...
    public NewsAdapter_OLD(ArrayList<NewsDataModel> data, Context context, RecyclerView recyclerView, SharedPrefUtils sharedPrefUtils) {
        this.dataSet = data;
        this.context = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.recycler_news_test, parent, false);
                ...
                public void run() {
                    ...
                    if (postMessage.getLineCount() > APIValues.maxLinesBeforeExpand) {
                        ...
                        if (!dataSet.get(listPosition).getExpandedState()) {
                            ...
                            expandMessage.setMaxLines(APIValues.maxLinesBeforeExpand);
                            expandMessage.setVisibility(View.VISIBLE);
                            expandMessage.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
